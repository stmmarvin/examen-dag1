<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <p class="text-gray-600 mb-6">Bekijk je eigen afspraken als medewerker.</p>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Notities</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($appointments as $appointment)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <div class="font-medium">{{ $appointment->treatment->name }}</div>
                                    <div class="text-gray-500">{{ $appointment->duration_minutes }} min</div>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                        ...
                                        @elseif($appointment->status == 'voltooid') bg-blue-100 text-blue-800
