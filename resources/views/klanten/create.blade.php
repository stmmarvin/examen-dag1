                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('klanten.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="voornaam" class="block mt-1 w-full" type="text" name="voornaam" :value="old('voornaam')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="telefoon" class="block mt-1 w-full" type="text" name="telefoon" :value="old('telefoon')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="geboortedatum" class="block mt-1 w-full" type="date" name="geboortedatum" :value="old('geboortedatum')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="adresregel1" class="block mt-1 w-full" type="text" name="adresregel1" :value="old('adresregel1')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="postcode" class="block mt-1 w-full" type="text" name="postcode" :value="old('postcode')" placeholder="1234AB" />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="allergieen" name="allergieen" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('allergieen') }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="wensen" name="wensen" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('wensen') }}</textarea>
                            <x-input-error :messages="$errors->get('wensen')" class="mt-2" />
                        </div>

                        <!-- Buttons -->
                        <div class="flex items-center justify-end mt-6 gap-4">
                            <x-secondary-button type="button" onclick="window.location='{{ route('klanten.index') }}'">
                                {{ __('Annuleren') }}
                            </x-secondary-button>
